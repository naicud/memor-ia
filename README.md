...
MEMORIA exposes **82 tools**, **7 resources**, and **5 prompts** via [Model Context Protocol](https://modelcontextprotocol.io/) for integration with Claude Desktop, Cursor, VS Code, and any MCP-compatible client.
...
> 📖 **Full MCP reference with all 82 tools:** [docs/MCP_SERVER.md](docs/MCP_SERVER.md)
...
| [**MCP Server Guide**](docs/MCP_SERVER.md)     | Complete MCP reference: 82 tools, 6 resources, 5 prompts, client config (Claude Desktop, Cursor, VS Code), Docker deployment |
