...
{
  "status": "created",
  "id": "/Users/danielnicusornaicu/.claude/projects/test_developer_onboarding_conv0-48599d281e840059/memory/a362f8fd.md",
...
{
  "status": "created",
  "id": "/Users/danielnicusornaicu/.claude/projects/test_developer_onboarding_conv0-48599d281e840059/memory/e3b64d6c.md",
...
{
  "status": "created",
  "id": "/Users/danielnicusornaicu/.claude/projects/test_developer_onboarding_conv0-48599d281e840059/memory/19e9cdfb.md",
...
```json
{
  "core": {
    "total_memories": 3,
    "memory_dir": "/Users/danielnicusornaicu/.claude/projects/test_developer_onboarding_conv0-48599d281e840059/memory"
  },
  "episodic": {
    "total_episodes": 0,
    "active_episode": null,
...
```json
{
  "project_dir": "/private/var/folders/fv/mf1hrly52x52xn37lc4wq3y00000gn/T/pytest-of-danielnicusornaicu/pytest-247/test_developer_onboarding_conv0",
  "memory_dir": "/Users/danielnicusornaicu/.claude/projects/test_developer_onboarding_conv0-48599d281e840059/memory",
  "version": "2.0.0",
  "backends": {
...
```json
{
  "episode_id": "5e598d7c7d0e",
  "title": "Debug sqlite-vec INSERT OR REPLACE failure",
  "started_at": 1775125313.611797,
  "ended_at": null,
  "agent_id": "",
  "session_id": "",
  "summary": "",
...
```json
{
  "event_id": "84318ac86f0d",
  "event_type": "observation",
  "content": "test_vector.py::test_upsert fails with: UNIQUE constraint failed: vec_embeddings.id. The INSERT OR REPLACE statement isn't working.",
  "timestamp": 1775125313.61359,
  "agent_id": "",
  "user_id": "",
  "metadata": {},
  "importance": 0.5
...
```json
{
  "event_id": "b2be7e7a1329",
  "event_type": "tool_use",
  "content": "Tried using ON CONFLICT clause but sqlite-vec virtual tables don't support it. The SQLite docs confirm virtual tables have limited DML support.",
  "timestamp": 1775125313.6146939,
  "agent_id": "",
  "user_id": "",
  "metadata": {},
  "importance": 0.5
...
```json
{
  "event_id": "d815e927d2fb",
  "event_type": "decision",
  "content": "Decision: Use DELETE + INSERT pattern instead. First DELETE WHERE id = ?, then INSERT. This works for both single and batch operations.",
  "timestamp": 1775125313.6157088,
  "agent_id": "",
  "user_id": "",
  "metadata": {},
  "importance": 0.5
...
```json
{
  "event_id": "e307d77df768",
  "event_type": "milestone",
  "content": "Fix applied in vector/client.py lines 95-138. Both insert() and insert_batch() now use DELETE+INSERT. All 4044 tests pass.",
  "timestamp": 1775125313.616672,
  "agent_id": "",
  "user_id": "",
  "metadata": {},
  "importance": 0.5
...
{
  "status": "created",
  "id": "/Users/danielnicusornaicu/.claude/projects/test_debugging_conversation0-36e361b23f77cc44/memory/5a3fb7c3.md",
...
{
  "status": "created",
  "id": "/Users/danielnicusornaicu/.claude/projects/test_graph_enrichment_conversa0-762200f5deb7a25d/memory/eebd433e.md",
...
{
  "status": "created",
  "id": "/Users/danielnicusornaicu/.claude/projects/test_graph_enrichment_conversa0-762200f5deb7a25d/memory/a1c8f829.md",
...
{
  "status": "created",
  "id": "/Users/danielnicusornaicu/.claude/projects/test_graph_enrichment_conversa0-762200f5deb7a25d/memory/1862bc31.md",
...
```json
{
  "core": {
    "total_memories": 3,
    "memory_dir": "/Users/danielnicusornaicu/.claude/projects/test_graph_enrichment_conversa0-762200f5deb7a25d/memory"
  },
  "episodic": {
    "total_episodes": 0,
    "active_episode": null,
...
{
  "status": "created",
  "id": "a5dc1ddb-1e5a-4f44-a5a5-67c1f3ae77b0",
  "tier": "working"
}
```
...
{
  "status": "created",
  "id": "82da6197-4a63-4ffb-9cf0-9baa59d49665",
  "tier": "archival"
}
```
...
{
  "status": "granted",
  "grant_id": "c414eb8562ae446a84c66783f946e93c",
  "agent_id": "alice",
  "namespace": "project-memoria",
  "role": "reader"
}
...
```json
{
  ...
  "metadata": {},
  "registered_at": 1775125313.82933
}
```
...
```json
{
  "signal_id": "62fc91d3620c4a68a6a6b3cd67a61d82",
  "signal_type": "expansion_signal",
  "product_id": "memoria-mcp",
  "description": "User adopted 3 new feature categories",
  "impact_score": 0.7,
  "confidence": 0.8,
  "timestamp": 1775125313.837503,
  "evidence": [],
  "recommended_action": "",
  "metadata": {}
}
...
```json
{
  ...
  "content_id": "integrity-check-001",
  "status": "intact",
  "created_at": 1775125313.843894,
  "last_verified": 1775125313.843894,
...
```json
{
  ...
  "active_topics": 2,
  "context_switches": 1,
  "session_duration_minutes": 1.0629494984944662e-05,
  "timestamp": 1775125313.8451898
}
```
...
```json
{
  "session_id": "5dfe1adb-485f-43e5-97a8-6b576ecc4835",
  "started_at": 1775125313.846474,
  "ended_at": null,
  "focus_scores": [],
  "context_switches": 0,
  "topics": [],
...
{
  "status": "created",
  "id": "/Users/danielnicusornaicu/.claude/projects/test_full_workday_session0-961ca3bc3187058c/memory/916962fe.md",
...
```json
{
  "episode_id": "b9242e107ba2",
  "title": "Morning session: fix vector upsert bug",
  "started_at": 1775125313.855361,
  "ended_at": null,
  "agent_id": "",
  "session_id": "",
  "summary": "",
...
```json
{
  "event_id": "512184372dc2",
  "event_type": "observation",
  "content": "test_vector.py fails on INSERT OR REPLACE with sqlite-vec",
  "timestamp": 1775125313.856341,
  "agent_id": "",
  "user_id": "",
  "metadata": {},
  "importance": 0.5
...
```json
{
  "event_id": "c95040ec5269",
  "event_type": "decision",
  "content": "Virtual tables don't support ON CONFLICT. Using DELETE+INSERT.",
  "timestamp": 1775125313.857388,
  "agent_id": "",
  "user_id": "",
  "metadata": {},
  "importance": 0.5
...
{
  "status": "created",
  "id": "/Users/danielnicusornaicu/.claude/projects/test_full_workday_session0-961ca3bc3187058c/memory/adf08d3c.md",
...
{
  "tool_name": "pytest",
  "pattern_id": "6dfea9f9dbfb",
  "input_template": "pytest tests/ -q",
  "context_trigger": "verify fix",
  "success_rate": 1.0,
  "use_count": 1,
  "last_used": 1775125313.859516,
  "avg_duration_ms": 12000.0,
  "common_errors": []
}
```
...
{
  "status": "created",
  "id": "28fbbcd6-a3e9-4b16-b68a-baa372817106",
  "tier": "working"
}
```
...
### Turn 11: `memoria_insights` ✅ (161ms)
...
```json
{
  "core": {
    "total_memories": 2,
    "memory_dir": "/Users/danielnicusornaicu/.claude/projects/test_full_workday_session0-961ca3bc3187058c/memory"
  },
  "episodic": {
    "total_episodes": 1,
    "active_episode": null,
...
[
  {
    "id": "MemoryHeader(filename='adf08d3c.md', file_path='/Users/danielnicusornaicu/.claude/projects/test_full_workday_session0-961ca3bc3187058c/memory/adf08d3c.md', mtime_ms=1775125313858.4912, description=\"sqlite-vec virtual tables don't support INSERT OR REPLACE. Use DELETE + INSERT as workaround.\", type=<MemoryType.USER: 'user'>)",
    "error": "unreadable"
  },
  {
    "id": "MemoryHeader(filename='916962fe.md', file_path='/Users/danielnicusornaicu/.claude/projects/test_full_workda…
```
...
```json
{
  "project_dir": "/private/var/folders/fv/mf1hrly52x52xn37lc4wq3y00000gn/T/pytest-of-danielnicusornaicu/pytest-247/test_full_workday_session0",
  "memory_dir": "/Users/danielnicusornaicu/.claude/projects/test_full_workday_session0-961ca3bc3187058c/memory",
  "version": "2.0.0",
  "backends": {
    "graph": "KnowledgeGraph",
